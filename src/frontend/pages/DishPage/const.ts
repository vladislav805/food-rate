...
export const dishPageRatingCn = cnDishPage('Rating');
export const dishPageRateButtonCn = cnDishPage('RateButton');
export const dishPageReviewsCn = cnDishPage('Reviews');
